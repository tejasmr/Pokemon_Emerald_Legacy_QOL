...
const u8 gText_ThisIsAPokemon[] = _("This is what we call a “POKéMON.”{PAUSE 1}\p");
...
const u8 gText_PlayerUsedVar2_NoPause[] = _("{PLAYER} used the\n{STR_VAR_2}.");
...
const u8 gText_ModsPocket[] = _("MODS");
...
const u8 gText_12PoofForgotMove[] = _("1, {PAUSE 1}2, and{PAUSE 1}… {PAUSE 1}… {PAUSE 1}… {PAUSE 1}{PLAY_SE SE_BALL_BOUNCE_1}Poof!\p{STR_VAR_1} forgot how to\nuse {STR_VAR_2}.\pAnd…{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PartyWasRestored[] = _("Your party was restored.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_EggFromFortreeGym[] = _("A POKéMON EGG obtained\namid the rustling leaves\nof FORTREE GYM.");
...
const u8 gText_Petaya48BP[] = _("PETAYA BERRY{CLEAR_TO 0x5E}48BP");
const u8 gText_Apicot48BP[] = _("APICOT BERRY{CLEAR_TO 0x5E}48BP");
const u8 gText_Pomeg3BP[] = _("POMEG BERRY{CLEAR_TO 0x5E}3BP");
const u8 gText_Kelpsy3BP[] = _("KELPSY BERRY{CLEAR_TO 0x5E}3BP");
const u8 gText_Qualot3BP[] = _("QUALOT BERRY{CLEAR_TO 0x5E}3BP");
const u8 gText_Hondew3BP[] = _("HONDEW BERRY{CLEAR_TO 0x5E}3BP");
const u8 gText_Grepa3BP[] = _("GREPA BERRY{CLEAR_TO 0x5E}3BP");
const u8 gText_Tamato3BP[] = _("TAMATO BERRY{CLEAR_TO 0x5E}3BP");
...
const u8 gText_MoveRelearnerAndPoof[] = _("{PAUSE 1}1, {PAUSE 1}2, and {PAUSE 1}… {PAUSE 1}… {PAUSE 1}… {PAUSE 1}{PLAY_SE SE_BALL_BOUNCE_1}Poof!\p");
...
const u8 gText_BattleWasRefused[] = _("The battle was refused.{PAUSE 1}");
const u8 gText_RefusedBattle[] = _("Refused the battle.{PAUSE 1}");
...
const u8 gText_Stats_Move[]          = _("MOVE");
const u8 gText_Stats_MoveEgg[]       = _("EGG");
const u8 gText_Stats_MoveLevel[]     = _("LVL");
const u8 gText_Stats_MoveTutor[]     = _("TUTOR");
...
const u8 gText_Stats_EggCycles_HatchSteps[]     = _("HATCH STEPS:");
