...
static const u8 sText_StopLearningMove[] = _("{PAUSE 1}Stop learning\n{B_BUFF2}?");
...
static const u8 sText_ItemsCantBeUsedNow[] = _("Items can't be used now.{PAUSE 1}");
...
static const u8 sText_123Poof[] = _("{PAUSE 1}1, {PAUSE 1}2, and{PAUSE 1}… {PAUSE 1}… {PAUSE 1}… {PAUSE 1}{PLAY_SE SE_BALL_BOUNCE_1}Poof!\p");
...
const u16 gWrappedStringIds[NUM_TRAPPING_MOVES] =
{
    ...
    STRINGID_PKMNTRAPPEDINVORTEX,  // MOVE_RAZOR_WIND
};
...
const u8 gText_LinkStandby[] = _("{PAUSE 1}Link standby…");
