...
extern const u8 gText_TextSpeedInst[];
...
extern const u8 gText_Birch_AreYouSure_Normal[];
extern const u8 gText_Birch_AreYouSure_Hard[];
extern const u8 gText_Birch_AreYouSure_Hardcore[];
...
extern const u8 gText_EggFromFortreeGym[];
